...
function CycleDetailContent() {
  ...
  return <>
    ...
    {paymentMemberId && <PaymentSheet groupId={groupId} group={group} cycleNumber={cycleNumber} fixedMembershipId={paymentMemberId} onClose={() => setPaymentMemberId(null)} onDone={() => { setPaymentMemberId(null); void refresh() }} />}
  </>
}
