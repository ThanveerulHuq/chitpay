...
const MESSAGES: Record<Lang, Record<AppErrorCode, string>> = {
  en: {
    ...
    already_selected: 'A recipient was already selected for this cycle.',
    not_eligible: 'That member is not eligible for selection.',
    payout_pending: 'Record the payout before completing the cycle.',
  ...
  ta: {
    ...
    already_selected: 'இந்த சுற்றுக்கான பெறுநர் ஏற்கனவே தேர்ந்தெடுக்கப்பட்டுவிட்டார்.',
    not_eligible: 'இந்த உறுப்பினரை இப்போது தேர்ந்தெடுக்க முடியாது.',
    payout_pending: 'சுற்றை முடிப்பதற்கு முன் வழங்கலை பதிவு செய்யவும்.',
